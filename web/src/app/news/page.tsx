...
import { Newspaper, ArrowRight, Calendar, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        ...
        <div className="text-center">
          <div className="relative inline-block mb-5">
            ...
            >
              <Newspaper className="w-9 h-9 text-[#09090d]" />
            </div>
          </div>
                ...
                >
                  ...
                  {article.thumbnail ? (
                    ...
                    <div className="aspect-video bg-[rgba(212,168,75,0.04)] flex items-center justify-center">
                      <Newspaper className="w-10 h-10 text-[rgba(212,168,75,0.2)]" />
                    </div>
                  )}
